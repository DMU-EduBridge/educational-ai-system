...
학생의 학습 데이터를 분석하여 개인화된 학습 리포트를 생성하는 REST API입니다.

필요할 때마다 실시간으로 리포트를 생성할 수 있습니다.

---

## 🔄 주요 특징

- **온디맨드 생성**: 필요할 때마다 즉시 요청
- **개별 학생**: 특정 학생만 선택 가능
- **실시간 응답**: 12-22초 내 결과 반환
- **프론트엔드 통합 용이**: 간단한 HTTP 요청만으로 호출
